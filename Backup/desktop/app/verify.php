            ...
            <div class="page-content">
                ...
                <div class="row mx-0 h-100 justify-content-center">
                    <div class="col-10 col-md-6 col-lg-4 my-3 mx-auto text-center align-self-center">
                        <form method="POST" action="apply-next.php" class="login-input-content ">
                            <div class="row">
                                <div class="col">
                                    <h6 style="color: azure;"> UPLOAD YOUR PASSPORT SIZED PHOTO</h6>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <input type="file" class="form-control rounded text-center" name="userphoto" Required>
                                    <code><kbd style="color: azure;">Note : This Photo will appear on your future cards</kbd></code>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col">
                                    <h6 style="color: azure;">UPLOAD YOUR AADHAR CARD</h6>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p style="color: azure;">Front :  <input type="file" class="form-control rounded text-center" name="afront" placeholder="Frontside" Required></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p style="color: azure;">Back :  <input type="file" class="form-control rounded text-center" name="aback" placeholder="Backside" Required></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control rounded text-center" name="pass" placeholder="Enter Password" Required>
                            </div>
                            <button type="submit" name="submit" class="btn btn-block btn-success rounded border-0 z-3">Verify</button>
                        </form>
                        <br>
                        <br>
