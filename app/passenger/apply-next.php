                    ...
                    <div class="modal-body">
                        <a href="#" class="block user-fullmenu popup-close">
                            ...
                            <div class="media-content">
                                <h6><?php echo $name; ?> <br><small>India</small></h6>
                            </div>
                        </a>
                        <br>
                        <div class="row mx-0">
            ...
            <header class="row m-0 fixed-header">
                ...
                <div class="col center">
                    <a href="index.html" class="logo">
                        <figure><img src="img/logo.png" alt=""></figure>Card Application
                    </a>
                </div>
            </header>
            <div class="page-content">
                ...
                <div class="row mx-0 h-100 justify-content-center">
                    <div class="col-10 col-md-6 col-lg-4 my-3 mx-auto text-center align-self-center">
                        ...
                        <br>
                        <form method="POST" action="proceedpayment.php" class="login-input-content ">
                            <div class="form-group">
                                <select name="source" class="form-control rounded" required>
                                <option class="text-center" disabled selected> Select City 1</option>
                                <?php 
                                    $sql = "SELECT DISTINCT `source` FROM `routes`";
                                    if($dbresult = mysqli_query($conn, $sql)){
                                        if(mysqli_num_rows($dbresult) > 0){
                                            while($row0 = mysqli_fetch_array($dbresult)){
                                                echo '<option class="text-center" value="'.$row0['source'].'">'.$row0['source'].'</option>'; 
                                            }
                                        } 
                                        else{
                                            //echo "No records matching your query were found.";
                            ...
                            <div class="form-group">
                                ...
                                <option class="text-center" disabled selected> Select City 2</option>
                                <?php 
                                    $sql = "SELECT DISTINCT `destination` FROM `routes`";
                                    if($dbresult = mysqli_query($conn, $sql)){
                                        if(mysqli_num_rows($dbresult) > 0){
                                            while($row1 = mysqli_fetch_array($dbresult)){
                                                echo '<option class="text-center"value="'.$row1['destination'].'">'.$row1['destination'].'</option>'; 
                                            }
                                        } 
                                        else{
                                            //echo "No records matching your query were found.";
                            ...
                            <div class="form-group">
                                <select name="serv_type" class="form-control rounded" required>
                                    <option class="text-center" disabled selected>Select Service Type</option>
                                    <option class="text-center" value="ORDINARY">Day Ordinary (Lalpari)</option>
                                    <option class="text-center" value="SHIVSHAHI">Shivshahi</option>
                            ...
                            <div class="form-group">
                                <select name="duration" class="form-control rounded" required>
                                    <option class="text-center" value="1" selected>1 Month</option>
                                    <option class="text-center" value="2">2 Months</option>
                                    <option class="text-center" value="3">3 Months</option>
                                    <option class="text-center" value="6">6 Months</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control rounded text-center" name="pass" placeholder="Enter Password" Required>
                            </div>
                            <button type="submit" name="submit" class="btn btn-block btn-success rounded border-0 z-3; ">APPLY</button>
                        </form>
                        <br>
                        <br>
                ...
                <div class="footer-wrapper">
                    <div class="footer dark">
                        <div class="row mx-0">
                            ...
                            &copy Copyright 2023, TransCity <?php echo '<img src="img/logo.png" height=40px width=40px alt="">'; ?>
                            </div>
                        </div>
                    </div>
                </div>
