            ...
            <div class="page-content">
                <div class="content-sticky-footer">
                    ...
                    <div class="row mx-auto">
                        <div class="col-12">
                            <center>
                                <a class="btn btn-primary" href="fleet.php" class="text-white"><b>Add fleet</b></a>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mb-4 ">
                        <ul class="list-group">
                            <li class="list-group-item py-4">
                                <h5><i class="material-icons text-success vm mr-2">lock</i>Log In</h5>
                                <p class="mb-0">Log In with your Credentials provided by your Depot Manager.</p>
                            </li>
                            <li class="list-group-item py-4 text-right">
                                <h5><i class="material-icons text-danger vm ml-2">directions_bus</i> Add Fleet</h5>
                                <p class="mb-0">Click on 'Add Fleet' button & enter the trip details.</p>
                            </li>
                            <li class="list-group-item py-4">
                                <h5><i class="material-icons text-warning vm mr-2">scanner</i>Scanning Cards</h5>
                                <p class="mb-0">After entering the trip details, scanner window will appear. Place the passenger's QR code on his/her card over your camera to scan it.</p>
                            </li>
                            <li class="list-group-item py-4 text-right">
                                <h5><i class="material-icons text-primary vm ml-2">person_add</i> Add Passenger</h5>
                                <p class="mb-0">After Scanning the card, Click on the 'Add Passenger' button which will appear after a verified scan. If the card is not verified by the system, then provide them a normal ticket.</p>
                            </li>
                        </ul>
                    </div>
                </div>
