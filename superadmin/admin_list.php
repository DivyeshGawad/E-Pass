                                                          ...
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                ...
                                                                <p><strong>E-mail -</strong><span>'.$row['username'].'<span></p>
                                                                <p><strong>Depot -</strong><span>'.$row['depot'].'<span></p>
                                                                <p><strong>Contact Number -</strong><span>'.$row['contact'].'<span></p>
                                                              </div>
                                                              <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <a type="button" class="btn btn-secondary" href = "view_admins.php?id='.$row['id'].'">Manage</a>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>';
