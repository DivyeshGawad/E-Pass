                                            ...
                                            if($dbresult = mysqli_query($conn, $sql)){
                                                ...
                                                if(mysqli_num_rows($dbresult) > 0){
                                                    while($row = mysqli_fetch_array($dbresult)){
                                                        ...
                                                        <td>
                                                        <a type="button" class="btn btn-primary" href = "view_user.php?id='.$row['id'].'">View Details</a>
                                                        </td>
                                                        </tr>
                                                        <!-- Modal 
                                                          ...
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-footer">
                                                                ...
                                                                <a type="button" class="btn btn-secondary" href = "view_user.php?id='.$row['id'].'">View Details</a>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>-->';
